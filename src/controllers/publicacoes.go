...
func BuscarPublicacoes(w http.ResponseWriter, r *http.Request) {
	...
	repo := repositorios.NovoRepositorioDePublicacoes(db)
	publicacoes, erro := repo.Buscar(usuarioID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	repo := repositorios.NovoRepositorioDePublicacoes(db)
	publicacaoSalvaNoBanco, erro := repo.BuscarPorID(publicacaoID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível atualizar uma publicacao que não seja sua"))
		return
	}
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível deletar uma publicacao que não seja sua"))
		return
	}
...
func BuscarPublicacoesPorUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repo := repositorios.NovoRepositorioDePublicacoes(db)
	publicacoes, erro := repo.BuscarPorUsuario(usuarioID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
